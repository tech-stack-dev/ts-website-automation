...
Scenario: SearchResultsEqualsToEnteredTextInSearchByRoleField
	When User set 'Back-End Engineer' text to 'Search' input on 'HomePage' container
...
Scenario: PageDisplayedVacanciesAfterDeleteTextFromSearchField
	...
	When User set 'Any term' text to 'Search' input on 'HomePage' container
	When User clears input on 'HomePage' container
	Then '' text is displayed in 'Search' input on 'HomePage' container
