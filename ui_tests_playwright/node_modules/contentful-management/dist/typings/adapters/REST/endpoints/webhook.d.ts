...
export declare const createWithId: (http: AxiosInstance, params: GetWebhookParams, rawData: CreateWebhooksProps, headers?: AxiosRequestHeaders) => Promise<WebhookProps>;
