...
exports.SearchApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        search: function (query, limit, offset, options) {
    ...
    return {
        ...
        search: function (query, limit, offset, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.search(query, limit, offset, options)];
                        case 1:
...
exports.SearchApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         */
        search: function (query, limit, offset, options) {
            return localVarFp.search(query, limit, offset, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var SearchApi = /** @class */ (function (_super) {
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.search = function (query, limit, offset, options) {
        var _this = this;
        return exports.SearchApiFp(this.configuration).search(query, limit, offset, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return SearchApi;
}(base_1.BaseAPI));
