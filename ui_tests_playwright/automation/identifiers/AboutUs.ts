export default class AboutUs {
	...
	static OurHistory: string = 'ourHistory';
	static OurHistoryTitle: string = 'SectionTitle-OurHistoryTitle';

	static OurAchievements: string = 'ourAchievements';
	static OurAchievementsTitle: string = 'SectionTitle-OurAchievementsTitle';

	static AchivementBlock = 'Achievement';

	static TechstackInGrows: string = 'techstackInGrows';
	static TechstackInGrowsTitle: string =
		'SectionTitle-TechstackInGrowthTitle';

	static TechstackRoles: string = 'techstackRoles';
	...
	static EngineeringCulture: string = 'engineeringCulture';
	static EngineeringCultureTitle: string =
		'SectionTitle-EngineeringCultureTitle';
	...
	static EngineeringCultureCarousel: string =
		'CarouselPhotoBlock-EngineeringCulture';

	static SocialResponsibility: string = 'socialResponsibility';
	static SocialResponsibilityTitle: string =
		'SectionTitle-SocialResponsibilityTitle';
	static SR_Charity = 'Charity';
	static SR_EnvironmentalSafety = 'Environmental Safety';
	static SR_EducationSupport = 'Education Support';
	static SocialResponsibilityCarousel: string =
		'CarouselPhotoBlock-SocialResponsibility';

	static CandidatePath: string = 'candidatePath';
