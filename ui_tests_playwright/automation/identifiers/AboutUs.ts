export default class AboutUs {
	...
	static OurHistoryCarosel: string = 'CarouselInfoLineBlock-OurHistory';
	...
	static CandidateCarosel: string = 'CarouselInfoLineBlock-CandidatePath';

	static CaroselBlock: string = 'ContentLineBlock-ContentLineBlock';
