export default class Job {
	// Section blocks
	static AboutTheProductBlock = 'SectionBlock-AboutTheProduct';
	static TechnologyStackBlock = 'SectionBlock-TechnologyStack';
	static AboutTheRoleBlock = 'SectionBlock-AboutTheRole';
