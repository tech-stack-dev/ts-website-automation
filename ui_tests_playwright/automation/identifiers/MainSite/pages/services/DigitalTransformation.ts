...
export default class AiDevelopment extends GeneralContainersMainSite {
    ...
    static HowTechstackInfluence = 'Container-HowTechstackInfluence';
    static DigitalTransformationProductMap = 'Container-DigitalTransformationProductMap';
    static TechnologyTransformationWorkflow = 'Container-TechnologyTransformationWorkflow';
}
