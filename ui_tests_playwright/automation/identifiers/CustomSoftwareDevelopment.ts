export default class CustomSoftwareDevelopent {
	static TopSection = 'Container-TopSection';
	static CustomSoftwareDevelopmentForYourProduct = 'Container-CustomSoftwareDevelopmentForYourProduct';
	static CustomSoftwareDevelopmentServicesWeProvide = 'Container-CustomSoftwareDevelopmentServicesWeProvide';
	static TechnologyStack = 'Container-TechnologyStack';
	static CustomSoftwareDevelopmentBenefits = 'Container-CustomSoftwareDevelopmentBenefits';
