...
export default class BackEndServices extends GeneralContainersMainSite {
	...
	static TechArsenal = 'Container-TechArsenal';
	static WhyTechstack = 'Container-WhyTechstack';
	static Partnering = 'Container-Partnering';
	static PeekIntoBackend = 'Container-PeekIntoBackend';
	static BackendDevelopmentServices = 'Container-BackendDevelopmentServices';
	static HowWeCanWorkTogether = 'Container-HowWeCanWorkTogether';
}
