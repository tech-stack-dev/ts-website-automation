...
export default class TechnologyStackData {
	...
	static CustomOfferFullCycleSoftwareDevvelopment = ['First consultation', 'Needs analysis and planning', 'Customized offer', 'Engagement phase'];
	static CustomOfferExtendedTeam = ['First consultation', 'Pre-engagement stage', 'Engagement phase'];
	static CostFullCycleSoftwareDevelopment = ['Scope and complexity', 'Specific product requirements', 'Technology stack', 'Timeframe'];
	static CostExtendedTeam = ['Skill set', 'Seniority level', 'Technology stack'];

	public static async getAllCustomOfferTabsData() {
		return [
			this.CustomOfferFullCycleSoftwareDevvelopment,
			this.CustomOfferExtendedTeam,
		]
	}
	public static async getAllCostTabsData() {
		return [
			this.CostFullCycleSoftwareDevelopment,
			this.CostExtendedTeam,
		];
	}
