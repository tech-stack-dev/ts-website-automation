export default class CaseStudyImagesPath {
	private static path = 'automation/preconditionsData/contentfulData/contentfulCaseStudiesImages';
	static PreviewImage = `${this.path}/caseStudyPreviewImage.jpg`;
