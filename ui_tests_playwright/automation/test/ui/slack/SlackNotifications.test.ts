...
test("Check Slack notification from 'staging_techstack_hr_notify' channel from Contact Us page @Regression @ContactUs @TSWEB-606 @TSWEB-560 @TSWEB-560", async () => {
...
test("Check Slack notification from 'staging_techstack_hr_notify' channel from Apply for a Job page @Regression @ContactUs @TSWEB-606 @TSWEB-560 @TSWEB-560", async () => {
	await baseDriverSteps.goToUrl(UrlProvider.careerUrl());
...
test("Check Slack notification from 'staging_techstack_notify' channel from 'About Us', 'How We Work' and 'Contact Us' pages @Regression @ContactUs @TSWEB-606 @TSWEB-560 @TSWEB-560", async () => {
...
test("Check Slack notification from 'staging_techstack_notify' channel from all 'Services' pages @Regression @ContactUs @TSWEB-606 @TSWEB-560 @TSWEB-560", async () => {
