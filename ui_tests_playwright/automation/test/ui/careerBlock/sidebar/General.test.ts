...
for (const testData of testDataProvider) {
	test(`Check that user sees vacancy by tags that were selected in ${testData.filterBlock} filter in side bar @Regression @FilterBlock @TSWEB-145 @TSWEB-622`, async () => {
