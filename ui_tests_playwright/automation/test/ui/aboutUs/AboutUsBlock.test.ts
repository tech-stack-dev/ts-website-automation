...
test("Check the 'Our History' carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-622", async () => {
...
test("Check the 'Candidate Path' carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-622", async () => {
...
test("Check the 'Techstack roles', 'Engineering Culture' and 'Social Responsibility' blocks from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-622", async () => {
...
test("Check the buttons of the info carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-622", async () => {
