...
test("Check the section title and number from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @smoke @TSWEB-560 @TSWEB-560', async () => {
...
test("Check the 'Our History' carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-560 @TSWEB-150 @TSWEB-560 @TSWEB-560', async () => {
...
test("Check the 'Candidate Path' carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-560 @TSWEB-150 @TSWEB-560 @TSWEB-560', async () => {
...
test("Check the 'Techstack roles', 'Engineering Culture' and 'Social Responsibility' blocks from the 'AboutUs' block @Regression @AboutUs @TSWEB-560 @TSWEB-150 @TSWEB-560 @TSWEB-560', async () => {
...
test("Check the 'Apply' block from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-560', async () => {
...
test("Check the buttons of the photo carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-560 @TSWEB-560 @TSWEB-560', async () => {
...
test("Check the buttons of the info carousel from the 'AboutUs' block @Regression @AboutUs @TSWEB-150 @TSWEB-560 @TSWEB-560', async () => {
