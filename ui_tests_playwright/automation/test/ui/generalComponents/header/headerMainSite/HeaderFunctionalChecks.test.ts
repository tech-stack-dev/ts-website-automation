...
test(`Check the redirection to the main page by clicking on the "Techstack" logo in the "Header" on all pages @Regression @Header @TSWEB-656`, async () => {
...
test(`Check the redirection for the Industries block in the "Header" on all pages @Regression @Header @TSWEB-656`, async () => {
...
test(`Check the redirection for the Services block in the "Header" on all pages @Regression @Header @TSWEB-656`, async () => {
...
test(`Check the redirection for the Company block in the "Header" on all pages @Regression @Header @TSWEB-656`, async () => {
...
test(`Check the redirection to the "Pricing" page by clicking on the "Pricing" button in the "Header" on all pages @Regression @Header @TSWEB-656`, async () => {
	for (const url of testDataProvider) {
		await baseDriverSteps.goToUrl(url);
