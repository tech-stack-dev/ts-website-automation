...
test("Check redirects by buttons in 'Consulting experts' container from the 'Consulting Service' block @Regression @ConsultingService @TSWEB-697", async () => {
	...
	const buttonUrlMap = new Map([
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(0), ExpertsLinkedInLinks.IvanIeremenko],
		[
		...
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(1), ExpertsLinkedInLinks.OleksiiSvystun],
		[
		...
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(2), ExpertsLinkedInLinks.YevheniiKarachevtsev],
		[
		...
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(3), ExpertsLinkedInLinks.VitaliiDolotov],
		[
		...
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(4), ExpertsLinkedInLinks.IvanYeremenko],
		[
		...
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(5), ExpertsLinkedInLinks.DmytroDytiuk],
		[
		...
		[consultingExpertsContainer.getByTestId(Button.LinkedIn2).nth(6), ExpertsLinkedInLinks.DmytroShtapauk],
		[
