...
test("Check the header from the 'QA as a Service' block @Regression @QaAsAService @TSWEB-603 @TSWEB-560", async () => {
...
test("Check the container title and number from the 'QA as a Service' block @Regression @QaAsAService @TSWEB-603 @TSWEB-560", async () => {
...
test("Check the sections of the containers from the 'QA as a Service' block @Regression @QaAsAService @TSWEB-603 @TSWEB-560", async () => {
...
test("Check the 'Services' blocks from the 'QA as a Service' block @Regression @QaAsAService @TSWEB-603 @TSWEB-560", async () => {
