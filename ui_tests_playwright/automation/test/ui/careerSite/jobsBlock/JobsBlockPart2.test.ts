...
test.describe('With one precondition vacancy', () => {
	...
	test(qase(5480, 'Check job description fields @mobile @Regression @JobsBlock @TSWEB-146'), async () => {
...
test.describe('with many precondition vacancy', () => {
	...
	test(
		qase(5260, 'Check pagination on "Career" page @desktop @mobile @Regression @JobsBlock @TSWEB-146'),
		async () => {
