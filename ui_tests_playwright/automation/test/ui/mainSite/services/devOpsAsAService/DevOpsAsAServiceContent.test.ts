...
test('Check the Info container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section numbers and titles in "DevOps Solution Benefits" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section titles in "Technology stack" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section titles and CTA in "Success Stories" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section numbers and titles in "Industries We Serve" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section titles and images in "Our Approach to DevOps" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section numbers and titles in "The Value Techstack Adds to Products" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check member names and roles, and CTA button in "Our DevOps experts" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section numbers and titles in "DevOps as a Service: Pipeline" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
	const devOpsAsAServiceContainer = driver.getByTestId(DevOpsAsAService.DevOpsAsAServicePipeline);

	await expect(devOpsAsAServiceContainer.getByTestId(Container.SectionNumber)).toHaveText(['01', '02', '03', '04']);
...
test('Check section titles in "Related Services" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
...
test('Check section titles in "FAQ" container from the "DevOps as a Service" page @Regression @DevOpsAsAService @TSWEB-1136', async () => {
