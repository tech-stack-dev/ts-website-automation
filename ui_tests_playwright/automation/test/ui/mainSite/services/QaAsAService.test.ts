...
test('Check the Info container from the "QA as a Service" page @Regression @QaAsAService @TSWEB-603', async () => {
...
test('Check section numbers and titles in containers from the "QA as a Service" page @Regression @QaAsAService @TSWEB-603', async () => {
...
test('Check block and section titles in "Services" container from the "QA as a Service" page @Regression @QaAsAService @TSWEB-603', async () => {
...
test('Check CTA button and redirect by arrow in "Our Approach and Achievements" container from the "QA as a Service" page @Regression @QaAsAService @TSWEB-603', async () => {
