...
test('Check navigation to "Get in Touch" container after clicking CTA buttons from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
		const ctaButtons = [
			driver.getByTestId(FrontEndDevelopment.Info).getByTestId(MainSiteButtons.RequestAQuote),
			driver.getByTestId(FrontEndDevelopment.FrontedWebDevelopment).getByTestId(MainSiteButtons.SubmitYourServiceRequestNow),
...
test('Check redirect by "Clutch Review" button in "Front-End Development Services Case Studies" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
...
test('Check redirect by CTA button in "Case Studies" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
...
test('Check redirect by "Clutch Review" button in "Why Techstack" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
...
test('Check redirects by LinkedIn buttons in "Our Front End Development Experts" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
...
test('Check redirects by Blog buttons in "Our Front End Development Experts" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
		const ourFrontEndExperts = driver.getByTestId(FrontEndDevelopment.OurExperts);
...
test('Check carousel arrows clicks in "Front-End Development Process" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
...
test('Check redirects by arrows in "Related Services" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
...
test('Check sections expanding and collapsing in "FAQ" container from the "Front End Development" page @Regression @FrontEndDevelopment @TSWEB-1274',
	async () => {
