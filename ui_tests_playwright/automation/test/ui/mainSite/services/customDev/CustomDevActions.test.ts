...
test(
	qase(
		5249,
		'Check redirect by CTA button in "Case Study by Techstack" container from the "Custom Software Development" page @desktop @mobile @Regression @CustomDev @TSWEB-672'
	),
	async () => {
