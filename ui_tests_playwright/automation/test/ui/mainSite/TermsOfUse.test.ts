...
test('Check title from the "Terms of use" page @Regression @TermsOfUse @TSWEB-1186', async () => {
...
test('Check the container title and number from the "Terms of use" page @Regression @TermsOfUse @TSWEB-1186', async () => {
	const containers = [
