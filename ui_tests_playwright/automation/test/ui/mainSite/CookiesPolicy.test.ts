...
test('Check title from the "Cookie policy" page @Regression @CookiePolicy @TSWEB-1186', async () => {
...
test('Check the container title and number from the "Cookie policy" page @Regression @CookiePolicy @TSWEB-1186', async () => {
	const containers = [
